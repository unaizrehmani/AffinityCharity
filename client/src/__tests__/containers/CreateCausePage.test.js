...
describe('title input', () => {
    it('should respond to change event and change the state accordingly', () => {
        const wrapper = shallow(<CreateCausePageContainer />)
        wrapper.find('#input-title').simulate('change', {target: {name: 'title', value: 'foo'}});
...
describe('type input', () => {
    it('should respond to change event and change the state accordingly', () => {
        const wrapper = shallow(<CreateCausePageContainer />)
        wrapper.find('#input-type').simulate('change', {target: {name: 'type', value: 'foo'}});
...
describe('location input', () => {
    it('should respond to change event and change the state accordingly', () => {
        const wrapper = shallow(<CreateCausePageContainer />)
        wrapper.find('#input-location').simulate('change', {target: {name: 'location', value: 'foo'}});
...
describe('description input', () => {
    it('should respond to change event and change the state accordingly', () => {
        const wrapper = shallow(<CreateCausePageContainer />)
        wrapper.find('#input-description').simulate('change', {target: {name: 'description', value: 'foo'}});
